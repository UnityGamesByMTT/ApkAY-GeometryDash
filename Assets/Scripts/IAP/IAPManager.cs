...
public class IAPManager : MonoBehaviour
{
    ...
    {
        PlayerPrefs.SetFloat("PlayTime", PlayerPrefs.GetFloat("PlayTime") +600);
    }
    public void OnPurchasefiveComplete(Product product)
    {
        PlayerPrefs.SetFloat("PlayTime", PlayerPrefs.GetFloat("PlayTime") + 3600);
    }
    public void OnPurchastenComplete(Product product)
    {
        PlayerPrefs.SetFloat("PlayTime", PlayerPrefs.GetFloat("PlayTime") + 3600*24);
    }
