...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] internal TMP_Text DiamondCount;
    [Space]
    [Header(" UI Panels")]
    ...
    private void Awake()
    {
        ...
        if (PlayerPrefs.GetInt("HumFirst") == 0)
        {
            PlayerPrefs.SetInt("HumFirst", 200);
            Debug.Log("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx");
            PlayerPrefs.SetFloat("PlayTime", 60);
        }
        DiamondCount.text = PlayerPrefs.GetFloat("PlayTime").ToString("F2");
